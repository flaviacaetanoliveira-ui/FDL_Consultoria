...
def test_nf_merge_key_nf_prefix_digits_unificado() -> None:
    assert normalize_nf_fiscal_commercial_join_key_scalar("NF-042517") == "42517"
    assert normalize_nf_fiscal_commercial_join_key_scalar("nf042517") == "42517"
    assert normalize_nf_fiscal_commercial_join_key_scalar("NF 042517") == "42517"


def test_nf_merge_key_preserves_alphanumeric_nao_so_nf_digitos() -> None:
    assert normalize_nf_fiscal_commercial_join_key_scalar("NF-042517-A") == "NF-042517-A"
